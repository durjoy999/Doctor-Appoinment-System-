                ...
                <div class="card">
                    <div class="card-body">
                         <div class="row align-items-center">
                          <form action="{{ route('admin.WhichHospitals.store') }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              <div class="row">
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="hospital_Location" class="form-control" value="{{ old('hospital_Location') }}" placeholder="Enter Hospital Location" />
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="seat" class="form-control" value="{{ old('seat') }}" placeholder="Enter Seat" />
                                        @error('seat')
                                        <span class="text text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fee" class="form-control" value="{{ old('fee') }}" placeholder="Enter Fee" />
                                        @error('fee')
                                        <span class="text text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
...
@section('admin_js')
    ...
    <script>
            Toast.fire({
                icon: 'success',
                title: 'Which Hospital Added Successfully'
            })
    </script>
    @endif
    @if ($errors->any())
